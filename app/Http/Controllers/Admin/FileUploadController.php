    ...
    protected function getApi($request)
    {
        ...
        foreach ($data as $key => $v) {
            ...
            if ($v['type'] == 'video') {
                ...
                $img_html = '<img class="img-fluid  maxH6rem" src="' . $v['view_src'] . '" alt="">';
            }

            $str .= '<div class="col-auto mb-2 upload-area-more-item" 
                    ...
                    data-origin_path="' . $v['origin_path'] . '">
                        <div class="card">
                            <div class="card-bdoy">
                                ...
                                <div class="card-title text-center mt-2" data-tips="tooltip" title="'.$v['tmp_name'].'">' . (mb_substr($v['tmp_name'],0,20)) . '</div>
